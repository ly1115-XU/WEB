        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="color: #9acfea">
            <ul class="nav navbar-nav">
                ...
                <li><a href="${pageContext.request.contextPath}/adminorder_list">订单管理</a></li>
                                ...
                                <li><a href="${pageContext.request.contextPath}/adminuser_list">销售人员管理</a></li>
                <%--                <li><a href="${pageContext.request.contextPath}/admingoods_statue?type=${user.admintype}">商品状态</a> </li>--%>
                <li><a href="${pageContext.request.contextPath}/adminsale_show?typeid=${user.admintype}">销售业绩</a></li>
                <li><a href="${pageContext.request.contextPath}/adminsale_stats?typeid=0">销售统计</a> </li>
                    <li><a href="${pageContext.request.contextPath}/user_impression">用户画像</a></li>
