...
public class UserDao {
    ...
    public void addUser(User user) {
        ...
        try {
            ...
            //sql
            String sql="insert into user(username,password,email,name,phone, address, isadmin,isvalidate) values(?,?,?,?,?,?,?,?)";
            //执行
            r.update(sql,user.getUsername(),user.getPassword(),user.getEmail(),user.getName(),
                    user.getPhone(),user.getAddress(),user.isIsadmin(),user.isIsvalidate());
